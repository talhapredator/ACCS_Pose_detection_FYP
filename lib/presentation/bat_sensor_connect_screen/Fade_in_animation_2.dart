...
class FadeInAnimation2 extends StatefulWidget {
  ...
  const FadeInAnimation2({required this.child});


  @override
  _FadeInAnimation2State createState() => _FadeInAnimation2State();
}

class _FadeInAnimation2State extends State<FadeInAnimation2> with SingleTickerProviderStateMixin {
